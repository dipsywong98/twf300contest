...
//        return $GLOBALS["db"]->select("usr","username",getLoginUsername())["hash"];
    ...
    function isAdmin(){
        $admin=["twf300_2017","a230459446","ericgau22","100002331046844@facebook.com","100003919138920@facebook.com","100000913023977@facebook.com","100001619080761@facebook.com"];
